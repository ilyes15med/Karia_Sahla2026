...
<div class="mt-12 p-5 bg-cyan-600 ">
    ...
    <form action="" method="GET" class="flex flex-wrap items-end gap-4">
        ...
        <!-- Date arrivée -->
        <div class="flex flex-col">
            <label for="date_arrivee" class="text-sm font-medium text-gray-700">
                Date d'arrivée
            </label>
            <input 
                type="date" 
        ...
        <!-- Date départ -->
        <div class="flex flex-col">
            <label for="date_depart" class="text-sm font-medium text-gray-700">
                Date de départ
            </label>
            <input 
                type="date" 
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <div>
                    ...
                    <input 
                        ...
                        min="1" 
                        value="1"
                        class="w-full border border-gray-300 rounded-lg px-2 py-1 focus:ring-2 focus:ring-blue-500">
                </div>
