    ...
    <form action="{{route('hebergement.update',$Heb->id)}}" method="post" class="space-y-4 w-full max-w-md" enctype="multipart/form-data">
        ...
        <div id="etape1" class="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <h2 class="text-2xl text-center font-bold mb-6">
                modifier la demande  d'un hébergement
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div id="chambre_lit_block" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="Nmbr_chambres"
                               class="w-full border rounded-lg px-3 py-2"  value="{{ $Heb->nombre_chambre }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="Nmbr_lits"
                               class="w-full border rounded-lg px-3 py-2" value="{{ $Heb->nombre_lit }}" >
                    </div>
                ...
                <div>
                    ...
                    <textarea name="description"
                              rows="4"
                              class="w-full border rounded-lg px-3 py-2"
                              required>{{$Heb->Description}}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="condition"
                              rows="4"
                              class="w-full border rounded-lg px-3 py-2">{{$Heb->politiqueHeb}}</textarea>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="Latitude"
                               class="w-full border rounded-lg px-3 py-2" value="{{ $Heb->latitude }}" 
                               required>
                    </div>
        ...
        <div id="etape3"
            ...
            <div class="mb-4">
                ...
                <input type="number"
                       ...
                       class="w-full border rounded-lg px-3 py-2"
                       min="0"
                       placeholder="Montant par personne et par nuit" value="{{ $Heb->montant_taxe_sejour }}">
            </div>
            ...
            <div class="mt-6">
                ...
                <input type="text"
                       name="code_Promo"
                       id="code_Promo"
                       class="w-full border rounded-lg px-3 py-2" value="{{ $Heb->code_promo }}">
            ...
            <div id="promo_wrapper" class="hidden mt-4">
                ...
                <input type="number"
                       ...
                       class="w-full border rounded-lg px-3 py-2"
                       min="0"
                       max="100" value="{{ $Heb->pourcentage_codepromo }}"/>

            </div>

            <input type="hidden" name="id_hote" value="{{ $Heb->users_id }}">
            ...
            <div class="flex gap-4 mt-6">
                ...
                <button type="submit"
                        class="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700">
                            <i class="fa-solid fa-spinner" ></i>   modifier le demande  d'hébergement
                </button>
...
// عند الكتابة
codePromo.addEventListener('input', verifierCodePromo);
